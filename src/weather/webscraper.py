...
result = file_requester(wban_list, "palashnoaascraper@gmail.com")
#Wait until all the requests are submitted and processed and the data is available
file_downloader(result, "palashnoaascraper@gmail.com")
...
def file_requester(zipcodes_array, email_id):
    ...
    for i in zipcode_list:
        for retry in range(3):
            driver = webdriver.Chrome(r"C:\Users\Palash Goiporia\AppData\Local\Temp\Temp1_chromedriver_win32 (1).zip\chromedriver.exe")
...
'''
    for i in orders:
        order_id = i[1]
        os.rename(r"C:\Users\Palash Goiporia\Downloads" + "\\" + order_id +".csv",r"C:\Users\Palash Goiporia\Downloads"+"\\"+location_abbrev[list(wban_list).index(i[0])] + "-" + file_suffix +".csv")
